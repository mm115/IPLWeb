...
namespace IPLWeb.Controllers
{
    ...
    public class SeasonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SeasonID,SeasonYear")] Season season)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SeasonID,SeasonYear")] Season season)
        {
