        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchTime = table.Column<string>(maxLength: 100, nullable: false),
                    SeasonID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Matches", x => x.TeamID);
                    table.ForeignKey(
            ...
            var sqlFile = Path.Combine(".\\Backup", @"ipl_data_backup.sql");
